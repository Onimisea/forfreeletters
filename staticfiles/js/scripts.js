document.addEventListener("DOMContentLoaded", function () {
  document.body.addEventListener("htmx:load", function () {
    ...
    // Get all buttons with the class name cate
      ...
      button.addEventListener("click", () => {
        ...
        document
          ...
          .addEventListener("click", function (event) {
            // Check if the clicked element is a subcate button
            if (event.target.classList.contains("subcate")) {
              // Handle the click event for subcate buttons here
              // For example, you can log the clicked subcategory
              templateSubcategory = event.target.id;
    ...
    // Define function to fetch and render data
    function fetchData(currentPage, templateCategory, templateSubcategory) {
