...
class GenericTemplate(models.Model):
    ...
    category = models.CharField(
        max_length=50, choices=CATEGORY_CHOICES, default="cv"
    )
    subcategory = models.CharField(
        max_length=100,
        choices=SUBCATEGORY_CHOICES,
        default="academic-and-education",
    )
    name = models.CharField(max_length=255, default="")
    file_upload = models.FileField(
        upload_to="media/generic_templates/", default=""
    )
    image_preview = models.ImageField(
        upload_to="media/generic_templates/previews/", default=""
    )
